...
pub enum EezeUdevWatch { }
#[repr(C)]
pub struct EezeVersion {
    pub major: c_int,
    pub minor: c_int,
    pub micro: c_int,
    pub revision: c_int,
...
pub type EezeUdevWatchCb = Option<unsafe extern "C" fn(arg1: *const c_char,
                                                       arg2: EezeUdevEvent,
                                                       arg3: *mut c_void,
                                                       arg4: *mut EezeUdevWatch)>;
#[link(name = "eeze")]
extern "C" {
    pub static mut eeze_version: *mut EezeVersion;
}
#[link(name = "eeze")]
extern "C" {
    ...
    pub fn eeze_udev_find_similar_from_syspath(syspath:
                                                   *const c_char)
     -> *mut EinaList;
    pub fn eeze_udev_find_unlisted_similar(list: *mut EinaList)
     -> *mut EinaList;
    ...
    pub fn eeze_udev_watch_add(_type: EezeUdevType,
     ...
     -> *mut EezeUdevWatch;
    pub fn eeze_udev_watch_del(watch: *mut EezeUdevWatch)
     -> *mut c_void;
}
