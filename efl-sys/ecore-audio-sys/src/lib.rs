...
extern "C" {
    pub static _ECORE_AUDIO_IN_EVENT_IN_LOOPED: Eo_Event_Description;
    pub static _ECORE_AUDIO_IN_EVENT_IN_STOPPED: Eo_Event_Description;
...
extern "C" {
    ...
    pub fn ecore_audio_class_get() -> *const Eo_Class;
    ...
    pub fn ecore_audio_in_class_get() -> *const Eo_Class;
    ...
    pub fn ecore_audio_obj_in_read_internal(buf: *mut c_void,
                                            len: size_t) -> ssize_t;
    pub fn ecore_audio_out_class_get() -> *const Eo_Class;
    ...
    pub fn ecore_audio_obj_out_input_detach(input: *mut Ecore_Audio_In)
     -> EinaBool;
    pub fn ecore_audio_obj_out_inputs_get() -> *mut Eina_List;
    pub fn ecore_audio_in_sndfile_class_get() -> *const Eo_Class;
    pub fn ecore_audio_out_sndfile_class_get() -> *const Eo_Class;
    pub fn ecore_audio_in_tone_class_get() -> *const Eo_Class;
    pub fn ecore_audio_out_pulse_class_get() -> *const Eo_Class;
}
#[cfg(test)]
mod tests {
    #[test]
