...
pub enum Ecore_File_Monitor { }
pub enum Ecore_File_Download_Job { }
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
#[repr(C)]
pub enum EcoreFileEvent {
    EcoreFileEventNone = 0,
    EcoreFileEventCreatedFile = 1,
    EcoreFileEventCreatedDirectory = 2,
    EcoreFileEventDeletedFile = 3,
    EcoreFileEventDeletedDirectory = 4,
    EcoreFileEventDeletedSelf = 5,
    EcoreFileEventModified = 6,
    EcoreFileEventClosed = 7,
}
pub type EcoreFileMonitorCb = Option<unsafe extern "C" fn(data: *mut c_void,
                                                           em: *mut Ecore_File_Monitor,
...
pub enum EcoreFileProgressReturn {
    EcoreFileProgressContinue = 0,
    EcoreFileProgressAbort = 1,
}
...
extern "C" {
    ...
    pub fn ecore_file_app_installed(exe: *const c_char)
     -> EinaBool;
    pub fn ecore_file_app_list() -> *mut Eina_List;
    pub fn ecore_file_download(url: *const c_char,
                               ...
                               data: *mut c_void,
                               job_ret: *mut *mut Ecore_File_Download_Job)
     -> EinaBool;
    pub fn ecore_file_download_full(url: *const c_char,
                                    ...
                                    data: *mut c_void,
                                    job_ret:
                                        *mut *mut Ecore_File_Download_Job,
                                    headers: *mut Eina_Hash) -> EinaBool;
    pub fn ecore_file_download_abort_all();
    pub fn ecore_file_download_abort(job: *mut Ecore_File_Download_Job);
