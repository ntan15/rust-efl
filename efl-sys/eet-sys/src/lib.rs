...
#[repr(C)]
pub struct EetDataDescriptorClass {
    pub version: c_int,
    pub name: *const c_char,
    pub size: c_int,
...
#[repr(C)]
#[derive(Copy)]
pub struct EetNodeData {
    pub value: EetUnionUnnamed2,
}
impl ::std::clone::Clone for EetNodeData {
    fn clone(&self) -> Self { *self }
}
impl ::std::default::Default for EetNodeData {
...
pub type EetNodeWalkInsertCallback =
    Option<unsafe extern "C" fn(array: *mut c_void,
                                ...
                                child: *mut c_void,
                                user_data: *mut c_void)>;
pub type EetNodeWalkListCallback =
...
pub type EetNodeWalkSimpleCallback =
    Option<unsafe extern "C" fn(_type: c_int,
                                data: *mut EetNodeData,
                                user_data: *mut c_void)
                              -> *mut c_void>;
#[repr(C)]
pub struct EetNodeWalk {
...
#[link(name = "eet")]
extern "C" {
    pub static mut eet_version: *mut EetVersion;
}
#[link(name = "eet")]
extern "C" {
    ...
    pub fn eet_open(file: *const c_char, mode: EetFileMode)
     -> *mut EetFile;
    pub fn eet_mmap(file: *const EinaFile) -> *mut EetFile;
    pub fn eet_memopen_read(data: *const c_void, size: size_t)
     -> *mut EetFile;
    pub fn eet_mode_get(ef: *mut EetFile) -> EetFileMode;
    pub fn eet_close(ef: *mut EetFile) -> EetError;
    pub fn eet_sync(ef: *mut EetFile) -> EetError;
    pub fn eet_dictionary_get(ef: *mut EetFile) -> *mut EetDictionary;
    pub fn eet_dictionary_string_check(ed: *mut EetDictionary,
                                       string: *const c_char)
     -> c_int;
    pub fn eet_dictionary_count(ed: *const EetDictionary)
     -> c_int;
    pub fn eet_read(ef: *mut EetFile, name: *const c_char,
                    size_ret: *mut c_int)
     -> *mut c_void;
    pub fn eet_read_direct(ef: *mut EetFile,
                           name: *const c_char,
                           size_ret: *mut c_int)
     -> *const c_void;
    pub fn eet_write(ef: *mut EetFile, name: *const c_char,
                     data: *const c_void,
                     size: c_int,
                     compress: c_int)
     -> c_int;
    pub fn eet_delete(ef: *mut EetFile, name: *const c_char)
     -> c_int;
    pub fn eet_alias(ef: *mut EetFile, name: *const c_char,
                     destination: *const c_char,
                     compress: c_int) -> EinaBool;
    pub fn eet_file_get(ef: *mut EetFile) -> *const c_char;
    pub fn eet_alias_get(ef: *mut EetFile,
                         name: *const c_char)
     -> *const c_char;
    pub fn eet_list(ef: *mut EetFile, glob: *const c_char,
                    count_ret: *mut c_int)
     -> *mut *mut c_char;
    pub fn eet_list_entries(ef: *mut EetFile) -> *mut EinaIterator;
    pub fn eet_num_entries(ef: *mut EetFile) -> c_int;
    pub fn eet_read_cipher(ef: *mut EetFile,
                           name: *const c_char,
                           size_ret: *mut c_int,
                           cipher_key: *const c_char)
     -> *mut c_void;
    pub fn eet_write_cipher(ef: *mut EetFile,
                            name: *const c_char,
                            data: *const c_void,
                            size: c_int,
                            compress: c_int,
                            cipher_key: *const c_char)
     -> c_int;
    pub fn eet_data_image_header_read(ef: *mut EetFile,
                                      name: *const c_char,
                                      w: *mut c_uint,
                                      h: *mut c_uint,
                                      alpha: *mut c_int,
     ...
     -> c_int;
    pub fn eet_data_image_read(ef: *mut EetFile,
                               name: *const c_char,
                               w: *mut c_uint,
                               h: *mut c_uint,
                               alpha: *mut c_int,
                               ...
                               lossy: *mut EetImageEncoding)
     -> *mut c_void;
    pub fn eet_data_image_read_to_surface(ef: *mut EetFile,
                                          name: *const c_char,
                                          src_x: c_uint,
                                          src_y: c_uint,
                                          d: *mut c_uint,
                                          ...
                                          lossy: *mut EetImageEncoding)
     -> c_int;
    pub fn eet_data_image_write(ef: *mut EetFile,
                                name: *const c_char,
                                data: *const c_void,
                                w: c_uint,
                                h: c_uint,
    ...
    pub fn eet_data_image_encode(data: *const c_void,
                                 ...
                                 lossy: EetImageEncoding)
     -> *mut c_void;
    pub fn eet_data_image_header_read_cipher(ef: *mut EetFile,
                                             name: *const c_char,
                                             cipher_key: *const c_char,
                                             w: *mut c_uint,
                                             h: *mut c_uint,
                                             ...
                                             lossy: *mut EetImageEncoding)
     -> c_int;
    pub fn eet_data_image_colorspace_get(ef: *mut EetFile,
                                         name: *const c_char,
                                         cipher_key: *const c_char,
                                         cspaces: *mut *const EetColorspace)
     -> c_int;
    pub fn eet_data_image_read_cipher(ef: *mut EetFile,
                                      name: *const c_char,
                                      cipher_key: *const c_char,
                                      w: *mut c_uint,
                                      h: *mut c_uint,
                                      ...
                                      lossy: *mut EetImageEncoding)
     -> *mut c_void;
    pub fn eet_data_image_read_to_surface_cipher(ef: *mut EetFile,
                                                 name: *const c_char,
                                                 cipher_key: *const c_char,
                                                 src_x: c_uint,
                                                 src_y: c_uint,
                                                 ...
                                                 lossy: *mut EetImageEncoding)
     -> c_int;
    pub fn eet_data_image_read_to_cspace_surface_cipher(ef: *mut EetFile,
                                                        name: *const c_char,
                                                        cipher_key: *const c_char,
                                                        src_x: c_uint,
                                                        src_y: c_uint,
    ...
    pub fn eet_data_image_decode_to_cspace_surface_cipher(data: *const c_void,
                                                          ...
                                                          lossy: *mut EetImageEncoding)
     -> c_int;
    pub fn eet_data_image_write_cipher(ef: *mut EetFile,
                                       name: *const c_char,
                                       cipher_key: *const c_char,
                                       data: *const c_void,
                                       w: c_uint,
    ...
    pub fn eet_identity_open(certificate_file: *const c_char,
                             ...
                             cb: EetKeyPasswordCallback) -> *mut EetKey;
    pub fn eet_identity_close(key: *mut EetKey);
    pub fn eet_identity_set(ef: *mut EetFile, key: *mut EetKey)
     -> EetError;
    pub fn eet_identity_print(key: *mut EetKey, out: *mut FILE);
    pub fn eet_identity_verify(ef: *mut EetFile,
                               certificate_file:
                                   *const c_char)
     -> EinaBool;
    pub fn eet_identity_x509(ef: *mut EetFile,
                             der_length: *mut c_int)
     -> *const c_void;
    pub fn eet_identity_signature(ef: *mut EetFile,
                                  signature_length:
                                      *mut c_int)
     -> *const c_void;
    pub fn eet_identity_sha1(ef: *mut EetFile,
    ...
    pub fn eet_data_descriptor_new(name: *const c_char,
     ...
     -> *mut EetDataDescriptor;
    pub fn eet_data_descriptor2_new(eddc: *const EetDataDescriptorClass)
     -> *mut EetDataDescriptor;
    pub fn eet_data_descriptor3_new(eddc: *const EetDataDescriptorClass)
     -> *mut EetDataDescriptor;
    pub fn eet_data_descriptor_stream_new(eddc:
                                              *const EetDataDescriptorClass)
     -> *mut EetDataDescriptor;
    pub fn eet_data_descriptor_file_new(eddc:
                                            *const EetDataDescriptorClass)
     -> *mut EetDataDescriptor;
    pub fn eet_eina_stream_data_descriptor_class_set(eddc:
                                                         *mut EetDataDescriptorClass,
                                                     eddc_size:
                                                         c_uint,
                                                     name:
                                                         *const c_char,
    ...
    pub fn eet_eina_file_data_descriptor_class_set(eddc:
                                                   ...
                                                   size:
                                                       c_int)
     -> EinaBool;
    pub fn eet_data_descriptor_free(edd: *mut EetDataDescriptor);
    pub fn eet_data_descriptor_name_get(edd: *const EetDataDescriptor)
     -> *const c_char;
    pub fn eet_data_descriptor_element_add(edd: *mut EetDataDescriptor,
                                           name:
                                               *const c_char,
                                           _type: c_int,
                                           group_type: c_int,
                                           ...
                                           counter_name:
                                               *const c_char,
                                           subtype: *mut EetDataDescriptor);
    pub fn eet_data_read(ef: *mut EetFile, edd: *mut EetDataDescriptor,
                         name: *const c_char)
     -> *mut c_void;
    pub fn eet_data_write(ef: *mut EetFile, edd: *mut EetDataDescriptor,
                          name: *const c_char,
                          data: *const c_void,
                          compress: c_int)
     -> c_int;
    ...
    pub fn eet_data_text_undump(text: *const c_char,
                                ...
                                size_ret: *mut c_int)
     -> *mut c_void;
    pub fn eet_data_dump(ef: *mut EetFile,
                         name: *const c_char,
                         dumpfunc: EetDumpCallback,
                         dumpdata: *mut c_void)
     -> c_int;
    pub fn eet_data_undump(ef: *mut EetFile,
                           name: *const c_char,
                           text: *const c_char,
                           textlen: c_int,
                           compress: c_int)
     -> c_int;
    pub fn eet_data_descriptor_decode(edd: *mut EetDataDescriptor,
                                      data_in: *const c_void,
                                      size_in: c_int)
     -> *mut c_void;
    pub fn eet_data_descriptor_encode(edd: *mut EetDataDescriptor,
                                      data_in: *const c_void,
                                      size_ret: *mut c_int)
     -> *mut c_void;
    pub fn eet_data_read_cipher(ef: *mut EetFile,
                                edd: *mut EetDataDescriptor,
                                name: *const c_char,
                                cipher_key: *const c_char)
     -> *mut c_void;
    pub fn eet_data_read_cipher_buffer(ef: *mut EetFile,
                                       edd: *mut EetDataDescriptor,
                                       name: *const c_char,
                                       cipher_key:
                                           *const c_char,
    ...
    pub fn eet_data_xattr_cipher_get(filename: *const c_char,
                                     ...
                                     cipher_key:
                                         *const c_char)
     -> *mut c_void;
    pub fn eet_data_write_cipher(ef: *mut EetFile,
                                 edd: *mut EetDataDescriptor,
                                 name: *const c_char,
                                 cipher_key: *const c_char,
                                 data: *const c_void,
    ...
    pub fn eet_data_text_undump_cipher(text: *const c_char,
                                       ...
                                       size_ret: *mut c_int)
     -> *mut c_void;
    pub fn eet_data_dump_cipher(ef: *mut EetFile,
                                name: *const c_char,
                                cipher_key: *const c_char,
                                dumpfunc: EetDumpCallback,
                                dumpdata: *mut c_void)
     -> c_int;
    pub fn eet_data_undump_cipher(ef: *mut EetFile,
                                  name: *const c_char,
                                  cipher_key: *const c_char,
                                  text: *const c_char,
                                  textlen: c_int,
                                  compress: c_int)
     -> c_int;
    pub fn eet_data_descriptor_decode_cipher(edd: *mut EetDataDescriptor,
                                             data_in:
                                                 *const c_void,
                                             cipher_key:
                                                 *const c_char,
                                             size_in: c_int)
     -> *mut c_void;
    pub fn eet_data_descriptor_encode_cipher(edd: *mut EetDataDescriptor,
                                             data_in:
                                                 *const c_void,
                                             cipher_key:
                                                 *const c_char,
    ...
    pub fn eet_node_list_new(name: *const c_char,
                             nodes: *mut EinaList) -> *mut EetNode;
    ...
    pub fn eet_node_hash_new(name: *const c_char,
                             key: *const c_char,
                             node: *mut EetNode) -> *mut EetNode;
    pub fn eet_node_struct_new(name: *const c_char,
                               nodes: *mut EinaList) -> *mut EetNode;
    pub fn eet_node_struct_child_new(parent: *const c_char,
                                     child: *mut EetNode) -> *mut EetNode;
    pub fn eet_node_children_get(node: *mut EetNode) -> *mut EetNode;
    pub fn eet_node_next_get(node: *mut EetNode) -> *mut EetNode;
    pub fn eet_node_parent_get(node: *mut EetNode) -> *mut EetNode;
    pub fn eet_node_list_append(parent: *mut EetNode,
                                name: *const c_char,
                                child: *mut EetNode);
    pub fn eet_node_struct_append(parent: *mut EetNode,
                                  name: *const c_char,
                                  child: *mut EetNode);
    pub fn eet_node_hash_add(parent: *mut EetNode,
                             name: *const c_char,
                             key: *const c_char,
                             child: *mut EetNode);
    pub fn eet_node_dump(n: *mut EetNode, dumplevel: c_int,
                         dumpfunc: EetDumpCallback,
                         dumpdata: *mut c_void);
    pub fn eet_node_type_get(node: *mut EetNode) -> c_int;
    pub fn eet_node_value_get(node: *mut EetNode) -> *mut EetNodeData;
    pub fn eet_node_del(n: *mut EetNode);
    pub fn eet_data_node_encode_cipher(node: *mut EetNode,
                                       cipher_key:
                                           *const c_char,
                                       size_ret: *mut c_int)
     -> *mut c_void;
    pub fn eet_data_node_decode_cipher(data_in: *const c_void,
                                       ...
                                       size_in: c_int)
     -> *mut EetNode;
    pub fn eet_data_node_read_cipher(ef: *mut EetFile,
                                     name: *const c_char,
                                     cipher_key:
                                         *const c_char)
     -> *mut EetNode;
    pub fn eet_data_node_write_cipher(ef: *mut EetFile,
                                      name: *const c_char,
                                      cipher_key:
                                          *const c_char,
                                      node: *mut EetNode,
    ...
    pub fn eet_node_walk(parent: *mut c_void,
                         name: *const c_char,
                         root: *mut EetNode, cb: *mut EetNodeWalk,
                         user_data: *mut c_void)
     -> *mut c_void;
    pub fn eet_connection_new(eet_read_cb: *mut Option<extern "C" fn() -> EinaBool>,
     ...
     -> *mut EetConnection;
    pub fn eet_connection_received(conn: *mut EetConnection,
                                   data: *const c_void,
                                   size: size_t) -> c_int;
    pub fn eet_connection_empty(conn: *mut EetConnection) -> EinaBool;
    pub fn eet_connection_send(conn: *mut EetConnection,
                               edd: *mut EetDataDescriptor,
                               data_in: *const c_void,
                               cipher_key: *const c_char)
     -> EinaBool;
    pub fn eet_connection_node_send(conn: *mut EetConnection,
                                    node: *mut EetNode,
                                    cipher_key: *const c_char)
     -> EinaBool;
    pub fn eet_connection_close(conn: *mut EetConnection,
